<template>
  ...
  <div style="display: flex;flex-direction: column;align-items: center">
    ...
    <div v-show="status === 1" class="basicInfoBack">
      <el-form class="SubjectForm">
        <div class="subjectItems">
          <div class="subjectItem">
            ...
            <div>
              <!--用户-->
              <el-select v-model="subjects.userId" placeholder="请通过用户名/手机号搜索" :popper-append-to-body="false" filterable id="username" :disabled="isMoney">
                <el-option
          ...
          <div class="subjectItem">
            ...
            <div>
              <el-input v-model="user.accountType" type="text" :popper-append-to-body="false" placeholder="请选择账号类型" id="accountType" disabled></el-input>
    ...
    <div v-show="status === 2" class="materials">
      <el-form class="SubjectForm">
        <div class="subjectItems">
          <div class="subjectItem">
            <div class="itemTips">
    ...
    <div v-show="status === 3" class="rightsCollection">
      <div class="collectionItems">
        <div class="collTitle">
          <p class="collStar" v-if="this.isMoney">*</p>
          <p class="collTitleInner">权利集合</p>
          <p v-if="this.accountType === '机构'"></p>
        </div>
        <div class="collItem" v-for="(item, index) in selectRights" :key="'rights'+index">
          <img src="./../../../assets/img/function/selected.png" :alt="'selected'+index" class="selectIcon">
        </div>
      </div>
    </div>
  </div>
